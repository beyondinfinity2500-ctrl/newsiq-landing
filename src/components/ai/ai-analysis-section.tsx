...
import { Sparkles, AlertTriangle, TrendingUp, Clock, Layers, Globe2, ListChecks, ShieldAlert, Lightbulb } from "lucide-react";
...
export function AiAnalysisSection({ analysis }: { analysis: AiAnalysisPayload }) {
