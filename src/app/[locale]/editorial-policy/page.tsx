...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `${siteConfig.url}/${locale}/editorial-policy`,
      languages: Object.fromEntries(siteConfig.locales.map((l) => [l, `${siteConfig.url}/${l}/editorial-policy`])),
      ...{ "x-default": `${siteConfig.url}/en/editorial-policy` },
    },
    robots: { index: true, follow: true },
  };
}

const SECTIONS = ["sourcing", "review", "ai", "corrections", "feedback"] as const;
